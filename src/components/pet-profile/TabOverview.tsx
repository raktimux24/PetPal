  ...
  return (
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-blue-50 rounded-xl p-6">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h3 className="font-medium text-gray-900">Next Checkup</h3>
          </div>
          {upcomingHealthRecord ? (
            <>
              ...
              <p className="text-sm text-gray-500">{upcomingHealthRecord.title}</p>
            </>
          ) : (
            <>
              <p className="text-blue-600 font-medium">No upcoming checkups</p>
              <p className="text-sm text-gray-500">Schedule a checkup for your pet</p>
            </>
          )}
        </div>
        ...
        <div className="bg-purple-50 rounded-xl p-6">
          ...
          {latestActivity ? (
            <>
              <p className="text-purple-600 font-medium">{latestActivity.type}</p>
            ...
            <>
              <p className="text-purple-600 font-medium">No recent activities</p>
              <p className="text-sm text-gray-500">Start logging activities</p>
            </>
          )}
        </div>
      </div>
      ...
      <div className="bg-gray-50 rounded-xl p-6">
        <h3 className="font-medium text-gray-900 mb-4">About {pet.name}</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <dl className="space-y-4">
              <div>
                <dt className="text-sm text-gray-500">Species</dt>
                <dd className="text-gray-900">{pet.species}</dd>
              </div>
              {pet.breed && (
                <div>
              ...
              <div>
                ...
                <dd className="text-gray-900">{getAge()}</dd>
              </div>
            </dl>
          </div>
          <div>
            <dl className="space-y-4">
              {pet.color && (
                <div>
                  <dt className="text-sm text-gray-500">Color/Markings</dt>
              ...
              {pet.microchipId && (
                <div>
                  ...
                  <dd className="text-gray-900">{pet.microchipId}</dd>
                </div>
              )}
              {pet.dateOfBirth && (
                <div>
      ...
      {pet.medicalNotes && (
        <div>
          <h3 className="font-medium text-gray-900 mb-4">Medical Notes</h3>
          <p className="text-gray-500">{pet.medicalNotes}</p>
        </div>
      )}
