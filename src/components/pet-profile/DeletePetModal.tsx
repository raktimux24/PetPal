...
export function DeletePetModal({ isOpen, onClose, onConfirm }: DeletePetModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl max-w-md w-full p-6">
        ...
        <h3 className="text-lg font-semibold text-gray-900 text-center mb-2">Delete Pet Profile</h3>
